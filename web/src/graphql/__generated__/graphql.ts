...
export type GetSiteInfoQueryVariables = Exact<{
  logoId?: InputMaybe<Scalars['ID']['input']>;
}>;


export type GetSiteInfoQuery = { __typename?: 'RootQuery', generalSettings?: { __typename?: 'GeneralSettings', title?: string | null, description?: string | null } | null, mediaItem?: { __typename?: 'MediaItem', sourceUrl?: string | null, slug?: string | null, altText?: string | null } | null };


export const GetSiteInfoDocument = gql`
    query GetSiteInfo($logoId: ID = "logo") {
  generalSettings {
    title
    description
  }
  mediaItem(id: $logoId, idType: SLUG) {
    sourceUrl
    slug
    altText
  }
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    GetSiteInfo(variables?: GetSiteInfoQueryVariables, options?: C): Promise<GetSiteInfoQuery> {
      return requester<GetSiteInfoQuery, GetSiteInfoQueryVariables>(GetSiteInfoDocument, variables, options) as Promise<GetSiteInfoQuery>;
    }
  };
}
